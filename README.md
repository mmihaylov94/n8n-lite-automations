...
### 1️⃣ Stripe Payment Webhook (Lite)
...
Add your chosen license here (MIT recommended for Lite, or a custom license if you prefer controlled reuse).
